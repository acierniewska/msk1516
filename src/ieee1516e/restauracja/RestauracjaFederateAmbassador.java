...
public class RestauracjaFederateAmbassador extends NullFederateAmbassador {
    private RestauracjaFederate federate;
    ...
    public RestauracjaFederateAmbassador(RestauracjaFederate federate) {
    ...
    public void announceSynchronizationPoint(String label, byte[] tag) {
        ...
        if (label.equals(RestauracjaFederate.READY_TO_RUN))
